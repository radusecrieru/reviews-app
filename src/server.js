...
const getTopThree = (timestamp) => {
  const tick = Math.floor(timestamp / 30000);
  randomness[tick] = randomness[tick] || [
  ...
  return {
    timestamp,
    topThree: [
      REVIEWS[randomness[tick][0]],
      REVIEWS[randomness[tick][1]],
      REVIEWS[randomness[tick][2]],
    ],
  };
};
